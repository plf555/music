...
CREATE TABLE `admin`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '娑撳鏁?',
...
CREATE TABLE `collect`  (
  ...
  `create_time` varchar(24) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收藏时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 138 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '收藏' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `collect` VALUES (137, 95, 0, 83, NULL, '2025-03-01 20:49:57');
...
CREATE TABLE `comment`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `consumer_id` int(0) NULL DEFAULT NULL COMMENT '用户id',
  `type` tinyint(1) NULL DEFAULT NULL COMMENT '收藏类型，0歌曲1歌单',
  `song_id` int(0) NULL DEFAULT NULL COMMENT '歌曲id',
  `song_list_id` int(0) NULL DEFAULT NULL COMMENT '歌单id',
  `content` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '评论内容',
  `create_time` varchar(24) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '评论时间',
  `up` int(0) NULL DEFAULT 0 COMMENT '评论点赞数',
  `audit` varchar(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '审核是否通过',
  `audited` varchar(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '是否已审核，0:false, 1:true',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 54 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '歌曲评论' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `comment` VALUES (52, 95, 0, 60, NULL, '1', '2025-03-01 20:48:46', 0, NULL, '0');
INSERT INTO `comment` VALUES (53, 111, 1, NULL, 2, '1', '2025-03-25 16:20:07', 0, NULL, '0');
...
CREATE TABLE `consumer`  (
  ...
  `phone_num` char(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '电话号码',
  `email` char(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '邮箱',
  `birth` varchar(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '生日',
  `introduction` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '这个人很懒，还没有设置签名' COMMENT '签名',
  ...
  `create_time` varchar(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `update_time` varchar(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 112 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '前端用户' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of consumer
-- ----------------------------
INSERT INTO `consumer` VALUES (1, '测试用户', '123456', 1, '13800138000', 'test@example.com', '2000-01-01', '更新后的介绍', '上海', '/img/avatar/1647500516777mmexport1535557322633.jpg', '70-0-4', NULL);
...
INSERT INTO `consumer` VALUES (94, 'plf', '123465', 1, '13457926355', '573618801@qq.com', '', '', '', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-01', NULL);
INSERT INTO `consumer` VALUES (95, '123456456', 'E10ADC3949BA59ABBE56E057F20F883E', 1, '', '', '2025-01-01', '', '', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-01', NULL);
INSERT INTO `consumer` VALUES (96, '测试用户', '123456', 1, '13800138000', 'test@example.com', '2000-01-01', '这是测试账号', '北京', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-04', NULL);
INSERT INTO `consumer` VALUES (97, '测试用户123', '123456', 1, '13800138000', 'test@example.com', '2000-01-01', '这是测试账号', '北京', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-09', NULL);
INSERT INTO `consumer` VALUES (98, '测试用户123456', '123456', 1, '13800138000', 'test@example.com', '2000-01-01', '这是测试账号', '北京', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-09', NULL);
INSERT INTO `consumer` VALUES (99, '测试用户1234', '123456', 1, '13800138000', 'test@example.com', '2000-01-01', '这是测试账号', '北京', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-09', NULL);
INSERT INTO `consumer` VALUES (100, '测试用户1741531476850', '123456', 1, '13829882195', 'test1741531476852@example.com', '2000-01-01', '自动化测试账号', '北京', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-09', NULL);
INSERT INTO `consumer` VALUES (102, '测试用户1741532639289', '123456', 1, '13867573046', 'test1741532639289@example.com', '2000-01-01', '自动化测试账号', '北京', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-09', NULL);
INSERT INTO `consumer` VALUES (103, '测试用户1741532660367', '123456', 1, '13845357055', 'test1741532660367@example.com', '2000-01-01', '自动化测试账号', '北京', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-09', NULL);
INSERT INTO `consumer` VALUES (104, '测试用户1741532666256', '123456', 1, '13855211301', 'test1741532666256@example.com', '2000-01-01', '自动化测试账号', '北京', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-09', NULL);
INSERT INTO `consumer` VALUES (105, '测试用户1741532741302', '123456', 1, '13816184078', 'test1741532741302@example.com', '2000-01-01', '自动化测试账号', '北京', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-09', NULL);
INSERT INTO `consumer` VALUES (106, '测试用户1741533022520', '123456', 1, '13876867252', 'test1741533022520@example.com', '2000-01-01', '自动化测试账号', '北京', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-09', NULL);
INSERT INTO `consumer` VALUES (107, '测试用户1741533291831', '123456', 1, '13812866706', 'test1741533291831@example.com', '2000-01-01', '自动化测试账号', '北京', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-09', NULL);
INSERT INTO `consumer` VALUES (108, '测试用户1741533523591', '123456', 1, '13820238052', 'test1741533523591@example.com', '2000-01-01', '自动化测试账号', '北京', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-09', NULL);
INSERT INTO `consumer` VALUES (110, '测试用户1741533919061', '123456', 1, '13871589372', 'test1741533919061@example.com', '2000-01-01', '自动化测试账号', '北京', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-09', NULL);
INSERT INTO `consumer` VALUES (111, 'xxs1', '21DD2737F21F5CAD3459BAD845EEBF39', 1, '', '', '2025-03-03', '', '', '/img/avatar/defaultMaleAvatarImg.jpg', '2025-03-25', NULL);
...
CREATE TABLE `download_history`  (
  ...
  `user_id` int(0) NULL DEFAULT NULL COMMENT '-1表示未登录用户',
...
-- ----------------------------
INSERT INTO `download_history` VALUES (5, 95, 60, '2025-03-01 20:48:54');
...
) ENGINE = InnoDB AUTO_INCREMENT = 122 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '星级评价' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `list_song`  (
  ...
  `song_list_id` int(0) NULL DEFAULT NULL COMMENT '歌单id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 91 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '每一个歌单包含的歌曲列表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `play_history`  (
  ...
  `play_time` varchar(24) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '播放时间',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `play_history` VALUES (107, 95, 60, '2025-03-01 20:48:37');
INSERT INTO `play_history` VALUES (108, 95, 83, '2025-03-01 20:49:55');
INSERT INTO `play_history` VALUES (109, 111, 32, '2025-03-25 16:18:44');
INSERT INTO `play_history` VALUES (110, 111, 47, '2025-03-25 16:34:39');
INSERT INTO `play_history` VALUES (111, 111, 54, '2025-03-25 16:34:53');
INSERT INTO `play_history` VALUES (112, 111, 84, '2025-03-25 16:22:24');
INSERT INTO `play_history` VALUES (113, 111, 36, '2025-03-25 16:34:30');
INSERT INTO `play_history` VALUES (114, 111, 38, '2025-03-25 16:34:31');
INSERT INTO `play_history` VALUES (115, 111, 44, '2025-03-25 16:34:43');
INSERT INTO `play_history` VALUES (116, 111, 29, '2025-03-25 16:34:36');
INSERT INTO `play_history` VALUES (117, 111, 40, '2025-03-25 16:34:37');
INSERT INTO `play_history` VALUES (118, 111, 70, '2025-03-25 16:34:37');
INSERT INTO `play_history` VALUES (119, 111, 71, '2025-03-25 16:34:38');
INSERT INTO `play_history` VALUES (120, 111, 72, '2025-03-25 16:34:39');
INSERT INTO `play_history` VALUES (121, 111, 4, '2025-03-25 16:34:40');
INSERT INTO `play_history` VALUES (122, 111, 12, '2025-03-25 16:34:40');
INSERT INTO `play_history` VALUES (123, 111, 57, '2025-03-25 16:34:41');
INSERT INTO `play_history` VALUES (124, 111, 56, '2025-03-25 16:34:42');
INSERT INTO `play_history` VALUES (125, 111, 68, '2025-03-25 16:38:21');
...
CREATE TABLE `singer`  (
  ...
  `sex` int(0) NULL DEFAULT NULL COMMENT '性别（1男0女）',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 43 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '歌手' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `song`  (
  ...
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '歌曲名称',
  ...
  `lyric` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '姝岃瘝',
...
CREATE TABLE `song_list`  (
  ...
  `create_time` varchar(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  `star_level` varchar(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '星级',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '歌单' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `swiper`  (
  ...
  `singer_id` int(0) NOT NULL COMMENT '绑定歌手id',
